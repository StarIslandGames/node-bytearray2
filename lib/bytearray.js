...
export default class ByteArray {
	 ...
	 */
	compress(algorithm = CompressionAlgorithm.DEFLATE) {
		switch (algorithm) {
	 ...
	 */
	readObject() {
		throw new Error('readObject not implemented yet');
	 ...
	 * @param {CompressionAlgorithm} algorithm
	 */
	uncompress(algorithm = CompressionAlgorithm.DEFLATE) {
		switch (algorithm) {
			case CompressionAlgorithm.DEFLATE:
	 ...
	 */
	writeObject(object) {
		throw new Error('writeObject not implemented yet');
